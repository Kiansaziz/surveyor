...
if ($type == 'sxit') {
  ...
  $query .= "DELETE FROM tbl_jwb_ed_a WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
  $query .= "DELETE FROM tbl_jwb_ed_b WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
  ...
  $query .= "DELETE FROM tbl_jwb_gb_a WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
  $query .= "DELETE FROM tbl_jwb_gb_b WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
  ...
  $query .= "INSERT INTO tbl_jwb_ed_a SELECT * FROM tbl_jwb_en_a WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
  $query .= "INSERT INTO tbl_jwb_ed_b SELECT * FROM tbl_jwb_en_b WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
  ...
  $query .= "INSERT INTO tbl_jwb_gb_a SELECT * FROM tbl_jwb_en_a WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
  $query .= "INSERT INTO tbl_jwb_gb_b SELECT * FROM tbl_jwb_en_b WHERE nomor_kuesioner = '$nomor_kuesioner'; ";
