...
if($type == 'jawabanA')
{
  ...
  try {
     ...
     $tbl_a           = $DecodedDataArray->data->tbl_a;
     $query           = "SELECT * FROM $tbl_a WHERE nomor_kuesioner = '$nomor_kuesioner'";
...
if($type == 'jawabanB')
{
  ...
  try {
     ...
     $nomor_kuesioner = $DecodedDataArray->data->nomor_kuesioner;
     $tbl_b           = $DecodedDataArray->data->tbl_b;
     $query           = "SELECT * FROM $tbl_b WHERE nomor_kuesioner = '$nomor_kuesioner'";
     $run             = $conn->query($query);
     if ($run->num_rows != NULL) {
        $outp = $run->fetch_object();
     } else {
