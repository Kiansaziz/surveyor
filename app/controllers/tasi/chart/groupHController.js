    ...
    app.controller('groupHController', function($location, $scope, $http, toastr, filterFilter){
      ...
      var changeOutput801 = function(data, poin, type){
        ...
        },
        {
          ...
          data:
          [
            data.filter(function(el) { return el.p801a == 'Jarang' }).length,
            data.filter(function(el) { return el.p801b == 'Jarang' }).length,
            data.filter(function(el) { return el.p801c == 'Jarang' }).length,
            data.filter(function(el) { return el.p801d == 'Jarang' }).length,
          ]
        },
        {
          name: 'Sering',
          data:
          [
            data.filter(function(el) { return el.p801a == 'Sering' }).length,
            data.filter(function(el) { return el.p801b == 'Sering' }).length,
            data.filter(function(el) { return el.p801c == 'Sering' }).length,
            data.filter(function(el) { return el.p801d == 'Sering' }).length,
          ]
        },
        {
          ...
          data:
          [
            data.filter(function(el) { return el.p801a == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p801b == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p801c == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p801d == 'Selalu/Sangat Sering' }).length,
          ]
        }];
