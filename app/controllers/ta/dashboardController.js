(function(){
    ...
    app.controller('dashboardController', function($scope, $http, toastr, filterFilter){
      ...
      $scope.dashboardKuesioner = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=kuesioner").then(onSuccess, onError);
      }
      ...
      $scope.dashboardCapaian = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=capaian").then(onSuccess, onError);
      }
      ...
      $scope.dashboardCapaianPercent = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=capaian_percent").then(onSuccess, onError);
      }
      ...
      $scope.dashboardJenisKelamin = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=jenis_kelamin").then(onSuccess, onError);
      }
      ...
      $scope.dashboardProfesi = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=profesi").then(onSuccess, onError);
      }
      ...
      $scope.dashboardProfesiLain = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=profesi_lain").then(onSuccess, onError);
      }
      ...
      $scope.dashboardUsia = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=usia").then(onSuccess, onError);
      }
      $scope.dashboardUsia();
      ...
      $scope.dashboardPendidikan = function() {
        ...
        $http.post("../api/ta/dashboard.php?type=pendidikan").then(onSuccess, onError);
      }
