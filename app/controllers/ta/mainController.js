(function(){
    ...
    app.controller('mainController', function($scope, $rootScope, AuthService, $http, toastr, $filter, filterFilter, $route, $interval, $location){
      ...
      $scope.dataMainPesanKhusus = function() {
        ...
        $http.get("../api/ta/pesan.php?type=dataMainPesanKhusus&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainPesanKhusus();
      ...
      $scope.showModalPesanKhusus = function(detail){
        ...
        $http.post("../api/ta/pesan.php?type=responsePesanKhusus", data).then(onSuccess, onError);
      }
      ...
      $scope.dataMainPesanBroadcast = function() {
        ...
        $http.get("../api/ta/pesan.php?type=dataMainPesanBroadcast&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainPesanBroadcast();
