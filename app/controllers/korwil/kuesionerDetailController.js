(function(){
    ...
    app.controller('kuesionerDetailController', function($scope, $routeParams, $http, toastr, filterFilter, $location){
      ...
      var dataKuesionerDetail = function() {
        ...
        $http.post("../api/korwil/kuesioner.php?type=dataKuesionerDetail",{"nomor_kuesioner":$routeParams.nomor_kuesioner, "token":JSON.parse(localStorage['_token'])}).then(onSuccess, onError);
      }
      dataKuesionerDetail();
      ...
      var beda = function(){
        ...
        $http.post("../api/korwil/kuesioner.php?type=jawabanBeda",{"nomor_kuesioner":$routeParams.nomor_kuesioner}).then(onSuccess, onError);
      }
      ...
      var jawaban = function(bagian, grup){
        ...
        $http.post("../api/korwil/kuesioner.php?type=jawaban",{"bagian":bagian, "grup":grup, "nomor_kuesioner":$routeParams.nomor_kuesioner})
      ...
      $scope.ubahJawaban = function(grup, nomor_kuesioner, pertanyaan, jawaban, index){
        ...
        $http.post("../api/korwil/kuesioner.php?type=ubahJawaban",{"grup":grup, "nomor_kuesioner":nomor_kuesioner, "pertanyaan":pertanyaan, "jawaban":jawaban})
        .then(onSuccess, onError);
      }
