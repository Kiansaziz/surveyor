(function(){
    ...
    app.controller('mainController', function($scope, $rootScope, AuthService, $http, toastr, $filter, filterFilter, $route, $interval, $location){
      ...
      $scope.dataMainPesanKhusus = function() {
        ...
        $http.get("../api/kornas/pesan.php?type=dataMainPesanKhusus&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainPesanKhusus();
      ...
      $scope.showModalPesanKhusus = function(detail){
        ...
        $http.post("../api/kornas/pesan.php?type=responsePesanKhusus", data).then(onSuccess, onError);
      }
      ...
      $scope.dataMainPesanBroadcast = function() {
        ...
        $http.get("../api/kornas/pesan.php?type=dataMainPesanBroadcast&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainPesanBroadcast();
      ...
      $scope.dataMainProvinsi = function() {
        ...
        $http.get("../api/kornas/primary.php?type=dataProvinsi&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainProvinsi();
      ...
      $scope.dataMainKabupaten = function() {
        ...
        $http.get("../api/kornas/primary.php?type=dataKabupaten&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainKabupaten();
      ...
      $scope.dataMainKecamatan = function() {
        ...
        $http.get("../api/kornas/primary.php?type=dataKecamatan&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainKecamatan();
      ...
      $scope.dataMainKelurahan = function() {
        ...
        $http.get("../api/kornas/primary.php?type=dataKelurahan&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainKelurahan();
      ...
      $scope.dataMainKuesioner = function() {
        var onSuccess = function(response){
          if (response.data == "error") {
            ...
            $scope.capaianProv = function(prov){
              return (filterFilter( response.data, {valid_gabungan:'0',id_prov:prov.id}, true).length / filterFilter(response.data, {id_prov:prov.id}, true).length) * 100;
            }
            $scope.capaianKab = function(kab){
              return (filterFilter( response.data, {valid_gabungan:'0',id_kab:kab.id}, true).length / filterFilter(response.data, {id_kab:kab.id}, true).length) * 100;
            }
            $scope.capaianKec = function(kec){
              return (filterFilter( response.data, {valid_gabungan:'0',id_kec:kec.id}, true).length / filterFilter(response.data, {id_kec:kec.id}, true).length) * 100;
            }
            $scope.capaianKel = function(kel){
              return (filterFilter( response.data, {valid_gabungan:'0',id_kel:kel.id}, true).length / filterFilter(response.data, {id_kel:kel.id}, true).length) * 100;
            }
          }
        }
        var onError = function(reason){
        ...
        $http.get("../api/kornas/kuesioner.php?type=dataKuesioner&token=" + JSON.parse(localStorage['_token'])).then(onSuccess, onError);
      }
      $scope.dataMainKuesioner();
