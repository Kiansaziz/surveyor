    ...
    app.controller('groupEController', function($location, $scope, $http, toastr, filterFilter){
      ...
      var changeOutput501b = function(data, poin, type, sub){
        ...
        },
        {
          ...
          data:
          [
            data.filter(function(el) { return el.p501b1 == 'Jarang' }).length,
            data.filter(function(el) { return el.p501b2 == 'Jarang' }).length,
            data.filter(function(el) { return el.p501b3 == 'Jarang' }).length,
            data.filter(function(el) { return el.p501b4 == 'Jarang' }).length,
            data.filter(function(el) { return el.p501b5 == 'Jarang' }).length,
            data.filter(function(el) { return el.p501b6 == 'Jarang' }).length,
            data.filter(function(el) { return el.p501b7 == 'Jarang' }).length,
            data.filter(function(el) { return el.p501b8 == 'Jarang' }).length,
          ]
        },
        {
          name: 'Sering',
          data:
          [
            data.filter(function(el) { return el.p501b1 == 'Sering' }).length,
            data.filter(function(el) { return el.p501b2 == 'Sering' }).length,
            data.filter(function(el) { return el.p501b3 == 'Sering' }).length,
            data.filter(function(el) { return el.p501b4 == 'Sering' }).length,
            data.filter(function(el) { return el.p501b5 == 'Sering' }).length,
            data.filter(function(el) { return el.p501b6 == 'Sering' }).length,
            data.filter(function(el) { return el.p501b7 == 'Sering' }).length,
            data.filter(function(el) { return el.p501b8 == 'Sering' }).length,
          ]
        },
        {
          ...
          data:
          [
            data.filter(function(el) { return el.p501b1 == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p501b2 == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p501b3 == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p501b4 == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p501b5 == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p501b6 == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p501b7 == 'Selalu/Sangat Sering' }).length,
            data.filter(function(el) { return el.p501b8 == 'Selalu/Sangat Sering' }).length,
          ]
        }];
